  ...
  return (
    <div className={style.wrapper}>
        <div className={style.textInfoContainer}>
            Owned by <span className={style.owner}>KAYE</span>
        </div>
        <div className={style.iconTextInfoContainer}>
            <AiFillEye className={style.icon} />
            <div className={style.textInfoContainer}>3.8K views</div>
        </div>
        <div className={style.iconTextInfoContainer}>
            <AiFillHeart className={style.icon} />
            <div className={style.textInfoContainer}>180 favourites</div>
        </div>
    </div>
  )
}
